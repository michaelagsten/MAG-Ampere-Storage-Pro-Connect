...
# Technical system configuration keys
...
CONF_PV_FEED_IN_LIMIT_PERCENT = "pv_feed_in_limit_percent"
CONF_BASE_LOAD_W = "base_load_w"
CONF_FLEXIBLE_LOAD_AVAILABLE_W = "flexible_load_available_w"
CONF_MAX_STORAGE_CHARGE_POWER_W = "max_storage_charge_power_w"
CONF_CLIPPING_SAFETY_RESERVE_W = "clipping_safety_reserve_w"
...
# Technical system defaults
DEFAULT_BATTERY_NOMINAL_CAPACITY_KWH = 16.0
DEFAULT_PV_NOMINAL_POWER_KW = 8.0
DEFAULT_INVERTER_NOMINAL_POWER_KW = 6.0
DEFAULT_PV_FEED_IN_LIMIT_PERCENT = 60.0
DEFAULT_BASE_LOAD_W = 300.0
DEFAULT_FLEXIBLE_LOAD_AVAILABLE_W = 1700.0
DEFAULT_MAX_STORAGE_CHARGE_POWER_W = 6000.0
DEFAULT_CLIPPING_SAFETY_RESERVE_W = 500.0
